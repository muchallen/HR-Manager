...
if (isset($_POST['signup'])) {
    ...
    if ($count == 0) { // if email is not found add user
        ...
        $stmts = $conn->prepare("INSERT INTO users(username,email,password,account) VALUES(?, ?, ?,?)");
        $stmts->bind_param("ssss", $uname, $email, $password, $acc_type);
